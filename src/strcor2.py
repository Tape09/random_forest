...
for F in range(1,15):
    ...
    for i in range(n_iterations):
        ...
        forest=random_forest(data_train,data_type,y_train,y_type,n_classes,n_retry,number_of_trees=100,F=F,rc=True,min_leaf_size=1,f_num = "IG", f_cat = "IG", L=3)    
